...
public class ParityBitAdderV2 {
    String x;
    int parityType;

    public ParityBitAdderV2(String x, int parityType) throws NonBinaryValue, IllegalParityValue {
    ...
    public static void main(String[] args) {
        try {
            ParityBitAdderV2 pba = new ParityBitAdderV2(args[0], Integer.parseInt(args[1]));
